...
function About() {
    ...
    return (
        <div className="about" aria-label="About the production section"> 
            <img className="about-top-img" src={aboutTopImg} alt="Guitarists and drummer preforming live" />
            <img className="about-header-img" src={aboutHeaderImg} alt="Image text reads: a celebration of a musical icon"/>
