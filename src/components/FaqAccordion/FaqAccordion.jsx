    ...
    return (
        <div className="faq-accordion">
            ...
            <div className="acc-item">
                ...
                {isActive && <div className="acc-content">Layla and Other Assorted Eric Clapton Songs features a 60-minute opening acoustic act followed by a 90-minute electric act with a 15-minute intermission in between for a total event time of 2.5 hours.</div>}
                <hr className="faq-line"></hr>
            </div>
            <div className="acc-item">
                <div 
            ...
            <div className="acc-item">
                ...
                {isActive && <div className="acc-content">We kindly ask that you refrain from taking photographs and video during the performance.</div>}
                <hr className="faq-line"></hr>
            </div>
            <div className="acc-item">
                <div 
            ...
            <div className="acc-item">
                ...
                {isActive && <div className="acc-content">We don&apos;t currently offer merchandise. We encourage you to visit the <a className="acc-a-tag" href="https://store.ericclapton.com/">Shop</a> on the <a className="acc-a-tag" href="https://ericclapton.com/">Eric Clapton web site</a> for Clapton-branded shirts, caps and other goods.</div>}
                <hr className="faq-line"></hr>
            </div>
            <div className="acc-item">
                <div 
                ...
                {isActive && <div className="acc-content">While there are many online/offline sources of information about Eric Clapton, there is no substitute for the “horse’s mouth.” With striking intimacy and candor, Eric Clapton tells the story of his eventful and inspiring life in his poignant and honest autobiography, Clapton: The Autobiography. The book is available in print and audio. <br></br>Additionally, the documentary Eric Clapton: Life in 12 Bars takes a look at the life and work of Eric Clapton, told by those who have known him best—including BB King, Jimi Hendrix, and George Harrison and Patty Boyd—and includes narration from Eric Clapton himself. The film can be <a className="acc-a-tag" href="https://www.amazon.com/Eric-Clapton-Life-12-Bars/dp/B07C5YY12K">watched online</a> through Amazon Prime.</div>}
                <hr className="faq-line"></hr>
            </div>
            <div className="acc-item">
                <div 
                ...
                {isActive && <div className="acc-content"><a className="acc-a-tag" href="mailto:Info@LaylaShow.com">Contact us</a> with your additional questions.</div>}
                <hr className="faq-line"></hr>
            </div>
        </div>
    )
